...
contract TestLemonJetVault is Test, HelperContract {
    ...
    function testDepositAndWithdraw() public {
        ...
        uint beforeDepositBalance = asset.balanceOf(address(this));

        vault.deposit(1 ether, address(this));
        vault.redeem(vault.previewWithdraw(vault.previewRedeem(vault.balanceOf(address(this)))), address(this), address(this));

        uint afterWithdrawBalance = asset.balanceOf(address(this));
