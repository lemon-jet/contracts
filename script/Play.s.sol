...
contract PlayLemonJetScript is Script {
    function run() external {
        ...
        address payable ljtGame = payable(
            address(0x8938260E6418CF3b673C1E1bEcB61a77dFb1BB2f)
        );
        vm.startBroadcast(deployerPrivateKey);

        (bool success, ) = ljtGame.call{value: 1000000000000000, gas: 500000}(
            abi.encodeWithSelector(
                LemonJet.play.selector,
                111111,
                200,
                address(0xBa0d95449B5E901CFb938fa6b6601281cEf679a4)
            )
        );
